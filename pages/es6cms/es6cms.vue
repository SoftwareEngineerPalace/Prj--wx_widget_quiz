	...
	export default {
		...
		methods: {
			...
			async onAddOne(e : any) {
				...
				const rsp : any = await wx.cloud.callFunction({
					name: 'addQuiz',
					data: { ...data, init: false, dbName: 'es6' }
				})
